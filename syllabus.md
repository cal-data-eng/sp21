...
## Extensions
For administrative and logistics issues, deadline extension requests, alternate exam requests, DSP accommodations, or special accommodations (for emergencies or personal issues), please make a private post on Piazza. If you need an extension, please include your reason for requesting an extension and any relevant documentation if applicable. If you are a DSP student and your accommodation letter allows for extensions, you will be given 2 extra days per assignment deadline on top of your slip day allocation. If you require any extensions beyond that, please make a private post on Piazza or email both Allen and Mantej (emails on staff page). For more sensitive issues that you do not feel comfortable with posting on Piazza, feel free to email the professors or attend their office hours. However, we would recommend posting on Piazza if possible to ensure a quicker response.
